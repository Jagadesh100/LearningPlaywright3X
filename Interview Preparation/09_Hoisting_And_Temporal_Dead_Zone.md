...
7. **Which declarations are affected by the TDZ?**
   - `let`, `const`, `class` declarations, and default parameter references to earlier parameters.

8. **What is the difference between `undefined` and a TDZ `ReferenceError`?**
...
16. **What are the three hoisting scenarios demonstrated by function expressions?**
...
20. **Why does `const` need an initial value?**
...
21. **In a Playwright test, where might TDZ issues appear?**
...
22. **How do you avoid TDZ errors in your code?**
...
23. **What is the difference between hoisting and the TDZ?**
